      ...
      <?php if (isset($_SESSION['id'])) { ?>
        <li class="nav-item hsmall">
          <a class="nav-link waves-effect waves-light text-white rbsm">
            <i class="fas fa-coins"></i> ยอดเงิน <span id="point_nav"><?php echo number_format(get_credit(), 2); ?></span> บาท
          </a>
        </li>
        ...
        <li class="nav-item hsmall">
          <a href="<?php echo base_url() . "/profile/mailbox"; ?>" class="nav-link waves-effect waves-light text-white lbsm">
            <i class="fas fa-envelope"></i> กล่องจดหมาย
          </a>
        </li>
      ...
      <?php } else { ?>
        <li class="nav-item">
          <a href="<?php echo base_url(); ?>/contact" class="nav-link waves-effect waves-light text-white ctb">
            ติดต่อเรา <i class="far fa-comment-dots"></i>
          </a>
        </li>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
      <ul class="navbar-nav mr-auto" id="menutwo_nav">
        <li class="nav-item mr-2">
          <a class="nav-link" href="<?php echo base_url(); ?>/">หน้าแรก
            <span class="sr-only">(current)</span>
          </a>
        </li>
        <li class="nav-item mr-2">
          <a class="nav-link" href="<?php echo base_url(); ?>/csgogame">สุ่มรางวัล</a>
        </li>
        <li class="nav-item dropdown mr-2">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">เติมเงิน</a>
          <div class="dropdown-menu dropdown-server z-depth-2" aria-labelledby="navbarDropdownMenuLink-333">
            <a class="dropdown-item" href="<?php echo base_url(); ?>/payment/gift">เติมเงิน Truewallet</a>
          </div>
        </li>
        <li class="nav-item dropdown mr-2">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-222" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ไอดีเกม</a>
        ...
        <li class="nav-item mr-2">
          <a class="nav-link" href="<?php echo base_url(); ?>/code/2/1">ไอเท็มโค้ต</a>
        </li>
        <li class="nav-item dropdown mr-2">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-444" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">บัตรเติมเงิน</a>
        ...
        <li class="nav-item mr-2">
          <a class="nav-link" href="<?php echo base_url(); ?>/contact">ติดต่อ</a>
        </li>

        <?php if (isset($_SESSION['id'])) { ?>
          <li class="nav-item mr-2 ssmall">
            <a class="nav-link" href="<?php echo base_url(); ?>/"><i class="fas fa-coins"></i> ยอดเงิน <span id="point_nav"><?php echo number_format(get_credit(), 2); ?></span> บาท</a>
          </li>
          <li class="nav-item mr-2 ssmall">
            <a class="nav-link" href="<?php echo base_url(); ?>/profile/mailbox"><i class="fas fa-envelope"></i> กล่องจดหมาย</a>
          </li>
          <li class="nav-item mr-2 ssmall">
            <a class="nav-link" href="<?php echo base_url(); ?>/logout"><i class="fas fa-sign-out-alt"></i> ออกจากระบบ</a>
          </li>
        <?php } ?>
      </ul>
